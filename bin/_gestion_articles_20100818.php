...
///////////////////////////////////////////////////// LISTE LES FAMILLES (FINAL)	 
	 ...
	 if($u_droits == '' || $u_dgw == 1 ){
		 if(isset($fournisseurs_db)){
			 if(mysql_query("SHOW COLUMNS FROM $fournisseurs_db") && mysql_query("SHOW COLUMNS FROM `gestion_artfour`") ){
				 echo"
				 <a class='buttontd' style='cursor:pointer' onclick=\"document.getElementById('achafour').style.visibility='visible';ajaxfil('gafour','1');\">Achats / fournisseurs</a>";
				 $fourtruc='';
	...
	function conmulti(k){
	 ...
	 echo"<td align='right'>
		...
		if(isset($fourtruc)  ){
			$fourtruc.="<tr>
				...
				<td class='buttontd'><a class='info'>P. achat<span>prix de base</span></a></td>
			...
			if(isset($fourtruc) && ($u_droits == '' || $u_dgw == 1) ){
				...
				if($ref && mysql_num_rows($ref)>0){
					while($fo=mysql_fetch_array($ref)){
						...
						<td>
							<input type='text' name='prixpa_$fo[0]' value='$fo[2]' class='gaf_prix' onkeyup='ch_achat($fo[0],this.value,$s_id)'>&euro; 
						</td>
						<td>
							<input type='text' name='remisepa_$fo[0]' value='$fo[5]' class='gaf_txt'>%
						</td>
						<td align='right'>
						<input type='text' name='apach$fo[0]' value='$pach'   class='gaf_ro' readonly>&euro;
						</td>
						<td>
						...
						$fourtruc.="<td>
							<a onclick=\"document.getElementById('org$fo[0]').style.visibility='visible';\">Promo</a>
						...
						<td>";
						if($u_droits == '' || $u_active == 1 ){
							$fourtruc.="<a onclick='confsupa($fo[0],$s_id)'><img src='$style_url/$theme/trash.gif' border='none' alt='Supprimer'></a>";
						}
						$li++;
					$fourtruc.="</td>
						</tr>
	 ...
	 if($taxe_cible=='HT'){
		 if($u_droits == '' || $u_dgw == 1 ){
			 echo"
			 <td><input type='text' name='prix$s_id' value='$s_prix' size='6' style='text-align:right' onkeyup='ch_vente($s_id,\"pa\",this.value)'></td>
			<td><input type='text' name='promo$s_id' value='$s_promo' size='6' style='text-align:right'></td>
			<td><input type='text' name='libre_pro$s_id' value='$s_libre_pro' size='8'></td>
			<td class='cadre' style='border-width:0px;border-left-width:1px;'><input type='text' name='prix_pro$s_id' value='$s_prix_pro' size='6' style='text-align:right'  onkeyup='ch_vente($s_id,\"pro\",this.value)'></td>
			<td class='cadre' style='border-width:0px;border-right-width:1px;'><input type='text' name='promo_pro$s_id' value='$s_promo_pro' size='6' style='text-align:right'></td>
		";
		 }
		 else{
			 echo"
		 ...
		 if($u_droits == '' || $u_dgw == 1 ){
			 echo"
			 <td class='cadre' style='border-width:0px;border-left-width:1px'><input type='text' name='prix$s_id' value='$s_prix' size='6' style='text-align:right'  onkeyup='ch_vente($s_id,\"pa\",this.value)'></td>
			<td class='cadre' style='border-width:0px;border-right-width:1px;'><input type='text' name='promo$s_id' value='$s_promo' size='6' style='text-align:right'></td>
			<td><input type='text' name='libre_pro$s_id' value='$s_libre_pro' size='8'></td>
			<td><input type='text' name='prix_pro$s_id' value='$s_prix_pro' size='6' style='text-align:right'  onkeyup='ch_vente($s_id,\"pro\",this.value)'></td>
			<td><input type='text' name='promo_pro$s_id' value='$s_promo_pro' size='6' style='text-align:right'></td>
			";
		 }
		 else{
			 echo"
	...
	$fourh+=30;
			echo"
			 ...
			 <div style='position:relative;'>
				 <div id='achafour' class='buttontd' style='position:absolute;bottom:15px;_bottom:25px; left:0px;visibility:$vis; width:895px; z-index:390; border-width:2px; text-align:left;'>
				
					 <b>Prix d'achats</b><br>&nbsp;<span id='gaf_retour'></span>
					 
					 <a class='buttontd' style='cursor:pointer; position:absolute; top:5px; right:5px;' onclick=\"document.getElementById('achafour').style.visibility='hidden';ajaxfil('gafour','0');\">Fermer</a>
					 
					 <table id='quantfour' style='background:#DDD ;position:absolute; top:35px; left:0px; width:895px;height:$fourh"."px;visibility:hidden; z-index:4000;'><tr><td valign='middle' align='center'>
					 <span id='comref'></span><br>
					 <b>En commande :</b><br>
			 			<input type='hidden' name='gafref' value='0'>
						<input type='text' name='gafquant' value='1' size='5'>
					 ...
					 <div id='achatfour' class='cadre' style='position:relative;padding:0px; width:895px;height:$fourh"."px; overflow-y:scroll; overflow-x:visible;  border-style:inset;'>
					 <table cellspacing='0' cellpadding='2' class='gaf_table'>
						$fourtruc
					</table>
					 </div>
					 <br>
					 <a class='buttontd' onclick=\"document.fourmis.action='./?option=$option&part=$part&edit=$edit&update&fours=all&addfour=all#four$s_id';document.fourmis.submit();\">ok</a>
					 <br>
				 </div>			 
			 </div>
			 </td></tr>";
...
onblur='this.style.width=$minx;this.style.height=$miny;'><img id='imgcoor' src='../$mapcoord[$part]' border='none'  onclick='point_it(event)'>
	 ...
	 echo"<tr><td colspan='3'><img src='$style_url/$theme/g.gif' alt='_' height='3' width='100%'></td></tr>";
